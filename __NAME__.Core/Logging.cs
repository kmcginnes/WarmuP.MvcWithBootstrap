...
namespace __NAME__
{
    ...
    public static class LogExtensions
    {
        ...
        {
            return Dictionary.Value.GetOrAdd(objectName, __NAME__.Log.GetLoggerFor);
        }
    }
    ...
    public class NullLog : ILog, ILog<NullLog>
    {
        ...
        {
            var formattedMessage = string.Format("[{0} {1,5}] {2} - {3}",
                DateTime.Now.ToString("hh:mm:ss.fff tt"), prefix, _loggerName, string.Format(message, formatting));
        ...
        {
            WriteLog("INFO", message, formatting);
        }
        ...
        {
            WriteLog("WARN", message, formatting);
        }
        ...
        {
            WriteLog("ERROR", message, formatting);
        }
        ...
        {
            WriteLog("FATAL", message, formatting);
        }
